            ...
            <Body style={main}>
                <Container style={container}>
                    <Section style={logoContainer}>
                        <HeartPulseIcon className="w-50 h-50" />
                        <Text style={logoText}>CareQ</Text>
                    </Section>
                    ...
                    <Section style={appointmentDetails}>
                        ...
                        {duration && (
                            <>
                                ...
                                <Text style={detailValue}>{typeof duration === "number" ? `${duration} min` : duration}</Text>
                            </>
                        )}
                        ...
                        <Text style={detailValue}>CareQ</Text>
                    </Section>
                    ...
                    <Text style={footerText}>
                        If you have any questions, please contact us at support@careq.com
                    </Text>
                </Container>
            </Body>
        </Html>
