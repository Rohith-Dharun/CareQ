...
import {HeartPulseIcon, CalendarCheckIcon, UserIcon, HospitalIcon} from "lucide-react";
    ...
    return (
        <Card className="lg:col-span-2">
            <CardHeader>
                ...
                <CardDescription>Keep track of your hospital visits and health progress</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl border border-primary/20">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="font-semibold text-primary mb-1">Ready to manage your health?</h4>
                            <p className="text-sm text-muted-foreground mb-3">
                                Book your next hospital appointment or try our AI assistant for instant health guidance.
                            </p>
