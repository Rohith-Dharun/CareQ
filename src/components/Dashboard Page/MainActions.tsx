                ...
                <CardContent className="relative p-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Get instant health advice through voice calls</p>
                        </div>
                    </div>
                ...
                <CardContent className="relative p-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Schedule appointments with verified doctors</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-primary rounded-full"></div>
                            <span className="text-sm">Verified health professionals</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-primary rounded-full"></div>
