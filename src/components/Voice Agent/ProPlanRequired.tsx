                    ...
                    <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20">
                        <div className="relative z-10 flex items-center justify-between">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <h1 className="text-4xl font-bold mb-2">Upgrade to Pro to use Voice Assistant</h1>
                                    <p className="text-muted-foreground">
                                        The AI voice assistant is a premium feature. Upgrade to a Pro or Premium plan to unlock unlimited health consultations.
                                    </p>
                                </div>
                            </div>
